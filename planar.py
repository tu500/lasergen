...
class CutoutRect(PlanarObject):
    ...
    def __init__(self, size, center=False, layer=Layer('cutout')):
...
class CutoutRoundedRect(PlanarObject):
    ...
    def __init__(self, size, radius, center=False, layer=Layer('cutout')):
...
class HexBoltCutout(PlanarObject):
    ...
    def __init__(self, width, layer=Layer('cutout')):
...
class CircleCutout(PlanarObject):
    ...
    def __init__(self, radius, layer=Layer('cutout')):
...
class MountingScrewCutout(PlanarObject):
    ...
    def __init__(self, radius_head, radius_shaft, shaft_length, shaft_dir, layer=Layer('cutout')):
...
class FanCutout(PlanarObject):
    ...
    def __init__(self, size, center=True, layer=Layer('cutout')):
...
class AirVentsCutout(PlanarObject):
    ...
    def __init__(self, size, hole_target_size=(5,30), hole_distance=5, center=False, layer=Layer('cutout')):
